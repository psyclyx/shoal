...
# Inline 4x-ppmm-mami from ../privclyx/nixclyx/assets/palettes.
(def base00 [11 4 0 255])
(def base01 [22 14 3 255])
(def base02 [36 27 13 255])
(def base03 [67 57 42 255])
(def base04 [123 112 95 255])
(def base05 [184 172 154 255])
(def base06 [223 210 191 255])
(def base07 [250 236 217 255])
(def base08 [172 132 126 255])
(def base09 [215 116 0 255])
(def base0A [145 146 110 255])
(def base0B [125 152 124 255])
(def base0C [107 153 152 255])
(def base0D [128 143 174 255])
(def base0E [160 133 158 255])
(def base0F [105 105 104 255])
